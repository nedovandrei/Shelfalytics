...
namespace Shelfalytics.API.App_Start
{
    public class StartupIoC
    {
        public static AutofacWebApiDependencyResolver ConfigureIoC()
        {
            ...
            builder.RegisterType<SShelfRepository>().As<ISShelfRepository>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<SShelfService>().As<ISShelfService>().InstancePerLifetimeScope();
